          ...
          >
            <div className="relative group">
              ...
              <div className="relative w-full aspect-square rounded-xl overflow-hidden shadow-2xl border-4 border-white/20 group-hover:scale-105 transition-transform duration-500">
                <Image
                  src="/images/pratham-profile.jpg"
                  alt="Pratham Soni"
                  fill
              ...
              <CardContent className="p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    Backend-focused Software Engineer specialising in <span className="text-primary font-semibold">Spring Boot</span> and cloud-native application development. Experienced in integrating{" "}
                    <span className="text-emerald-600 font-semibold">LLM-driven workflows</span>, designing scalable REST APIs, and deploying backend services on AWS. Proven ability to quickly learn and deliver solutions in fast-paced environments.
                  </p>
                  <p className="text-muted-foreground">
                    Expert in <span className="text-slate-600 font-semibold">AI integration</span> using LangChain, LLM APIs (OpenRouter), and Pinecone for RAG pipelines. Proficient in Java, Kotlin, Dart, and SQL with hands-on expertise in Flutter, AWS (EC2, RDS, Lambda, S3), Docker, and modern DevOps practices.
                  </p>
                </div>
              </CardContent>
            </Card>
